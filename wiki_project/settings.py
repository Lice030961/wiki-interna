...
CF_CHAT_MODEL = os.getenv('CF_CHAT_MODEL', '@cf/meta/llama-3.3-70b-instruct-fp8-fast')
CF_VISION_MODEL = os.getenv('CF_VISION_MODEL', '@cf/meta/llama-3.2-11b-vision-instruct')
